...
public class SaveCSVToWeb {

        public static void main(String[] args) {

            // Define the URL of the web server where the CSV file will be uploaded
            String serverUrl = "http://example.com/upload";

            // Define the username and password for authentication (if required)
